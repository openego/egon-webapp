...
from egon.map.models import Region, District, Hospitals, HospitalsSimulated, Cluster, Nightlight
...
def load_data(models=None, verbose=True):
    ...
    for model in models:
        ...
        instance = RelatedModelLayerMapping(
            model=model,
            data=os.path.join(ROOT_DIR, "egon", "data", f"{model.data_file}.gpkg",),
